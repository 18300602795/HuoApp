...
import com.huosuapp.Bean.HotDanjiBean;
import com.huosuapp.text.R;

public class Hotdanji_adapter extends BaseAdapter {

	Typeface typeFace ;
	private HotDanjiBean.DataBean databean;
	public Hotdanji_adapter(HotDanjiBean.DataBean databean, Context context) {
...
//			vh.tv_count_size=(TextView) convertView.findViewById(R.id.tv_count_size);
		...
		HotDanjiBean.DataBean.GameListBean  gamelistbean=databean.getGame_list().get(position);
