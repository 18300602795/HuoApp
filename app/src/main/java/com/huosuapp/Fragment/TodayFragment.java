...
//                Logger.msg("开始刷新数据", "");
//                analysisDate(today_pager, result);
            ...
            public void onLoadMore() {
                Logger.msg("开始下拉加载更多", today_pager + "");
//                listView.mFooterView.mHintView.setText("没有更多数据了");
//                listView.mFooterView.setState(XFooterView.STATE_LOADING);
//                analysisDate(today_pager, result);
                Message msg = new Message();
                msg.what = 2;
...
//            }
            ...
            Logger.msg("2222222", kaidus.size() + "");
        } catch (Exception e) {
